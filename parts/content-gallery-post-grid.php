			<?php $i=0; while($i <= 2){ ?>	
				...
				<article class="col-sm-4 paca-standard-grid">
						...
						<div class="figure-wrapper <?php echo ($i==1 ? 'overlay-arrows':''); ?>">
							<figure>
								...
								<ul class="grids-item-slider">
									<li><img src="<?php echo get_template_directory_uri() ?>/assets/img/small-<?php echo rand(1,5) ?>.jpg" title="title here" alt="alt-here" class="img-responsive featured-image" /></li>
									<li><img src="<?php echo get_template_directory_uri() ?>/assets/img/small-<?php echo rand(1,5) ?>.jpg" title="title here" alt="alt-here" class="img-responsive featured-image" /></li>
									<li><img src="<?php echo get_template_directory_uri() ?>/assets/img/small-<?php echo rand(1,5) ?>.jpg" title="title here" alt="alt-here" class="img-responsive featured-image" /></li>
									<li><img src="<?php echo get_template_directory_uri() ?>/assets/img/small-<?php echo rand(1,5) ?>.jpg" title="title here" alt="alt-here" class="img-responsive featured-image" /></li>
								</ul>
